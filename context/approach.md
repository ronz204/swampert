...
La estructura de archivos y scripts esperada es:

```
modelos/                                 # E-R + modelo relacional (imagen o PDF)
scripts/
  ddl.sql                                # esquemas, tablas, constraints, tipos, índices
  seguridad.sql                          # roles, GRANT/REVOKE, RLS, pgcrypto
  datos_prueba.sql                       # 10 000+ filas por tabla principal
  consultas_optimizadas.sql              # consultas con EXPLAIN ANALYZE antes/después
  distribuida.sql + docker-compose.yml   # técnica distribuida elegida
  dashboard/                             # sistema dashboard con las consultas reporte
documentacion/                           # documento técnico + README de instalación
```

El README de instalación debe permitir levantar la base de datos completa desde cero, ejecutando los scripts en orden, en menos de 10 minutos.